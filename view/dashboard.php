...
function getdetailorder($id, $conn)
{
    $getdata = mysqli_query($conn, "SELECT  a.*,b.name sername
                                    FROM learning_modul_details a 
                                    left join learning_moduls b on a.learning_modul_id=b.id 
                                    left join instructors c on b.instructor_id =c.id 
                                    where a.learning_modul_id='" . $id . "'
                            ");
